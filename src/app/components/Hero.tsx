...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop: flush to edges. max(Nrem,…) avoids a “tiny corner” cliff at lg where pure gutter math ≈ 120px while copy is max-w-3xl — copy stays z-10 if art underlaps slightly */}
      <motion.div
      ...
      <motion.div
        className="hidden sm:flex absolute bottom-0 right-0 z-[1] w-[min(58rem,max(17rem,calc(50vw-4.25rem)))] md:w-[min(70rem,max(21rem,calc(50vw-6.25rem)))] lg:w-[min(82rem,max(26rem,calc(50vw-23.35rem)))] xl:w-[min(96rem,max(26rem,calc(50vw-23.42rem)))] 2xl:w-[min(112rem,max(28rem,calc(50vw-23.5rem)))] items-end justify-end pointer-events-none p-0"
        {...sideEnterMotion}
      ...
      >
        <img
          ...
          className="w-full h-auto max-h-[min(92dvh,clamp(36rem,70vw,84rem))] object-contain object-right-bottom origin-bottom-right scale-[1.18] lg:scale-[1.14] xl:scale-[1.1]"
          draggable={false}
        />
      </motion.div>
