...
import withoutImage from '@/assets/4032ba0b38a12acf65ad2f27674d4b81431314e0.gif';
import withImage from '@/assets/4fec24e54aaf45e3afd92a2ce7745cf5eca2e82c.gif';
...
export function Comparison() {
  ...
  return (
    <section className="py-12 sm:py-20 bg-gradient-to-b from-amber-50/20 via-white to-slate-50 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute top-1/4 left-0 w-64 sm:w-96 h-64 sm:h-96 bg-gradient-to-br from-[#D4A24A]/10 to-transparent rounded-full blur-xl sm:blur-3xl" style={{ transform: 'translateZ(0)' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-8">
          ...
          >
            {/* Glass-morphic card - no hover transform on mobile */}
          ...
          >
            {/* Premium card - simplified for better performance */}
            <div className="relative bg-gradient-to-br from-[#D4A24A]/10 to-amber-100/20 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-2 border-[#D4A24A]/40 sm:hover:-translate-y-2 transition-transform duration-300">
              {/* Golden glow effect - hidden on mobile for performance */}
              <div className="hidden sm:block absolute -inset-1 bg-gradient-to-r from-[#D4A24A]/40 via-amber-300/30 to-[#D4A24A]/40 rounded-3xl blur-lg opacity-60 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
